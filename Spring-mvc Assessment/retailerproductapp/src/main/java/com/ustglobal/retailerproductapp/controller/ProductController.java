package com.ustglobal.retailerproductapp.controller;
...
import com.ustglobal.retailerproductapp.service.ProductService;
...
public class ProductController {
	...
	public String register(User bean,ModelMap map) {
		...
		if(check) {
			map.addAttribute("msg", "You arer Registered");
		}else {
	...
	public String change(@SessionAttribute(name= "user", required = false) User user,
			ModelMap map,String password,String confirmpassword) {
