...
public class EmployeeDAOJdbcImpl implements EmployeeDAO {
	...
	private static final String URL = "jdbc:mysql://localhost:33062/ust_ty_web_db?user=root&password=root";
	private static final String DRIVER_CLASS_NAME = "com.mysql.jdbc.Driver";
	
	private static final String SELECT_SQL = "select * from employee_info where id = ?";
	private static final String INSERT_SQL = "insert into employee_info value(?, ?, ?, ?)";
